...
namespace MvCamCtrl.NET
{
    /// <summary>
    /// MyCamera
    /// 中文：MyCamera 类，封装相机 SDK 的主要接口，用于设备枚举、打开/关闭、取流、像素格式转换、参数读写等。
    /// </summary>
    public class MyCamera
    {
        ...
        /// <summary>
        /// Grab callback
        /// 中文：抓图回调，当 SDK 获取到一帧图像数据时会调用此回调（不推荐直接使用，优先使用扩展回调）。
        /// </summary>
        ...
        /// <summary>
        /// Grab callback
        /// 中文：扩展型抓图回调，提供更完整的帧信息结构，推荐在应用中使用此回调获取图像数据。
        /// </summary>
        /// <param name="pData">Image data</param>
        /// <param name="pFrameInfo">Frame info</param>
        /// <param name="pUser">User defined variable</param>
        ...
        /// 中文：XML 更新回调（接口不建议直接使用），用于 SDK 内部 XML 节点变化的通知。
        /// </summary>
        ...
        /// <summary>
        /// Exception callback
        /// 中文：异常回调，用于接收 SDK 报告的异常信息（如设备断开、内部错误等）。
        /// </summary>
        ...
        /// 中文：事件回调（接口不建议直接使用），用于接收用户定义 ID 的事件通知。
        /// </summary>
        ...
        /// <summary>
        /// Event callback
        /// 中文：扩展型事件回调，返回结构化的事件信息，推荐在需要事件细节时使用。
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// 中文：获取 SDK 版本号。返回值为 4 字节的版本信息（Main/Sub/Rev/Test）。
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// 中文：通用接口，用于获取整型节点的值，例如 "Width"、"Height" 等。
        /// </remarks>
